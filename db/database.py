...
HOST = os.getenv("DB_HOST")
DATABASE = os.getenv("DB_NAME")
DB_PORT = os.getenv("DB_PORT", "1433")  # default 1433 si no está

# Verifica que las variables estén bien
print(f"DB_HOST={HOST}, DB_PORT={DB_PORT}, DB_NAME={DATABASE}, USER={USER_NAME}")
